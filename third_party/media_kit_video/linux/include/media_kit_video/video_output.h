...
/**
 * Attempts to lock the completed software frame until
 * video_output_release_software_frame() is called. Returns FALSE immediately
 * while the worker is converting a frame so Flutter's raster thread never
 * waits behind video work.
 */
