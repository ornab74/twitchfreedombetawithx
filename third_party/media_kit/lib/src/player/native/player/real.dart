  ...
  NativeReferenceHolder.ensureInitialized((references) async {
    ...
    try {
      for (final reference in references) {
        // This handle belongs to the isolate that existed before hot restart.
        // Its NativeCallable has already been deleted, so asking mpv to quit
        // before detaching the wakeup hook can call back into freed Dart code.
